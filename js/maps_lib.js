(function (window, undefined) {
    var MapsLib = function (options) {
        ...
        //-----custom initializers-----
            ...
            var maxDate = moment("Apr 25 2016"); 
        
            //starting values
            var startDate = moment("Jan 1 2010");
            var endDate = moment("Apr 25 2016"); //now
  ...
  MapsLib.prototype.sliderInterval = function(interval) {
    ...
    MapsLib.prototype.doSearch = function () {
        ...
        //date slider
        self.whereClause += " AND 'COLLISION DATE' >= '" + $('#startDate').html() + "'";
        self.whereClause += " AND 'COLLISION DATE' <= '" + $('#endDate').html() + "'";
